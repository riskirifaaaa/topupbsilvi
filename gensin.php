  ...
  <div class="container mx-auto p-4">
   <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/3 p-4">
     <img alt="Free Fire characters" class="w-full mb-4" height="300" src="https://cdn1.codashop.com/S/content/common/images/mno/Genshin%20Impact%20V4.1%20Update%20.png" width="600"/>
     <h1 class="text-2xl font-bold mb-4">
     GENSHIN IMPACT
     </h1>
     <p class="mb-4">
      Unduh Genshin Impact sekarang!
...
Cukup masukkan user ID anda, Pilih jumlah Diamond yang ingin anda beli, pilih metode pembayaran yang anda inginkan, selesaikan pembayaran, dan Diamonds anda akan segera ditambahkan ke akun Genshin Impact.
     </p>
    </div>
    <!-- Right Section -->
