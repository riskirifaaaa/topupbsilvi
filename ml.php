  ...
  <div class="container mx-auto p-4">
   <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/3 p-4">
     <img alt="Free Fire characters" class="w-full mb-4" height="300" src="https://cdn1.codashop.com/S/content/common/images/mno/ID.jpg" width="600"/>
     <h1 class="text-2xl font-bold mb-4">
      MOBILE LEEGENS
     </h1>
     <p class="mb-4">
      Unduh Mobile Legends sekarang!
...
Cukup masukkan user ID anda, Pilih jumlah Diamond yang ingin anda beli, pilih metode pembayaran yang anda inginkan, selesaikan pembayaran, dan Diamonds anda akan segera ditambahkan ke akun Mobile Legends.
     </p>
    </div>
    <!-- Right Section -->
