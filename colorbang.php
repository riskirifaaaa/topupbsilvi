  ...
  <div class="container mx-auto p-4">
   <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/3 p-4">
     <img alt="Free Fire characters" class="w-full mb-4" height="300" src="https://cdn1.codashop.com/images/0e86db4e-de4e-44b1-8a41-cba266966fc0.png" width="600"/>
     <h1 class="text-2xl font-bold mb-4">
     Color Bang Top-up
     </h1>
     <p class="mb-4">
      Unduh Color Bang sekarang!
...
Cukup masukkan user ID anda, Pilih jumlah Diamond yang ingin anda beli, pilih metode pembayaran yang anda inginkan, selesaikan pembayaran, dan Diamonds anda akan segera ditambahkan ke akun Color Bang.
     </p>
    </div>
    <!-- Right Section -->
