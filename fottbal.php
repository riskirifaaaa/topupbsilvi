  ...
  <div class="container mx-auto p-4">
   <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/3 p-4">
     <img alt="Free Fire characters" class="w-full mb-4" height="300" src="https://cdn1.codashop.com/S/content/common/images/mno/fm24_coda_640x241%20(1).jpg" width="600"/>
     <h1 class="text-2xl font-bold mb-4">
     FottBall Manager 2024
     </h1>
     <p class="mb-4">
      Unduh FottBall Manager 2024 sekarang!
      NjaySHop menyediakan Transaksi yang mudah, aman, dan instan.
...
Cukup masukkan user ID anda, Pilih jumlah Diamond yang ingin anda beli, pilih metode pembayaran yang anda inginkan, selesaikan pembayaran, dan Diamonds anda akan segera ditambahkan ke akun FottBall Manager 2024.
     </p>
    </div>
    <!-- Right Section -->
    <div class="lg:w-2/3 p-4">
      ...
      <div class="bg-white text-purple-900 p-4 rounded">
       <h2 class="text-xl font-bold mb-2">
         ISI LEBIH BANYAK COIN LEBIH BAIK
       </h2>
...
<form id="topupForm" action="process.php" method="POST">
    ...
    <div class="bg-white text-purple-900 p-4 rounded">
        ...
        <option value="50" price="5000">50 COIN</option>
          <option value="100" price="10000">100 COIN</option>
          <option value="200" price="20000">200 COIN</option>
          <option value="500" price="50000">500 COIN</option>
          <option value="1000" price="100000">1000 COIN</option>
          <option value="2000" price="200000">2000 COIN</option>
