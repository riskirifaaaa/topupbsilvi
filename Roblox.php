  ...
  <div class="container mx-auto p-4">
   <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:w-1/3 p-4">
     <img alt="Free Fire characters" class="w-full mb-4" height="300" src="https://cdn1.codashop.com/S/content/common/images/mno/Roblox%20logo%20640x241px.jpg" width="600"/>
     <h1 class="text-2xl font-bold mb-4">
     Roblox
     </h1>
     <p class="mb-4">
      Unduh Roblox sekarang!
...
Cukup masukkan user ID anda, Pilih jumlah Diamond yang ingin anda beli, pilih metode pembayaran yang anda inginkan, selesaikan pembayaran, dan Diamonds anda akan segera ditambahkan ke akun Roblox.
     </p>
    </div>
    <!-- Right Section -->
...
<form id="topupForm" action="process.php" method="POST">
    ...
    <div class="bg-white text-purple-900 p-4 rounded">
        ...
        <option value="50" price="5000">50 Card</option>
          <option value="100" price="10000">100 Card</option>
          <option value="200" price="20000">200 Card</option>
          <option value="500" price="50000">500 Card</option>
          <option value="1000" price="100000">1000 Card</option>
          <option value="2000" price="200000">2000 Card</option>
